...
- `cmm.fyi`(last checked: 23.02.24 04:10 cest)
...
- `forum-lucifer.com` (last checked: 22.02.24) (*fixed*)
...
- `toot.poedelwitz.de`
- `tootnet.nl`
- `vasra.masto.host` (*fixed*) (But still full of other spam/ClickBait)
- `waterlily.tokyo`
- `witten.social`

#### Threat Level 2: Store Spam but no longer send out Spam

- `freemasonry.social` (*spam paused*) (*can't load home timeline*) 
- `kotodama.space` (*spam paused*)
- `m.techsocial.site` (*spam paused*)
- `mastodon.mykotodama.space` (*spam paused*) (*offline*)
- `rtypedbs.hostdon.ne.jp` (*spam paused*) (*offline*)
